...
while user_str != 'calculate':
    ...
    if user_str == 'modify':
        modify_info()
        process_info()
    elif user_str == 'calculate':
        ret_inv = process_info()
        break

print(f"Future rental income will be ${roi.income:.2f}\nFuture rental expenses will be ${roi.expenses:.2f}\nFor the total investment of ${roi.investments:.2f}\nWill return a percentage of {ret_inv:.3f}%")
